<?php
/*
Plugin Name: Add PayPal Express
Plugin URI: 
...
function pmpro_add_paypal_express_register_styles() {
	wp_register_style( 'pmpro-add-paypal-express-styles', plugins_url( 'css/add-paypal-express.css', __FILE__ ) );
...
function pmproappe_pmpro_checkout_boxes()
{
	...
	<div id="pmpro_payment_method" class="pmpro_checkout" <?php if(!$pmpro_requirebilling) { ?>style="display: none;"<?php } ?>>
		<div class="pmpro_checkout-fields">
			...
			<span class="gateway_paypal <?php echo esc_attr($setting_gateway);?>">
				...
				<a href="javascript:void(0);" class="pmpro_radio">
                  	<?php _e('Check Out with a Credit Card Here', 'pmpro'); ?>
                    <img src="<?= get_stylesheet_directory_uri(); ?>/img/credit-cards.jpg"/>
                </a>
			</span>
			<?php } ?>
			<span class="gateway_paypalexpress">
				...
				<a href="javascript:void(0);" class="pmpro_radio">
                    ...
                    <img src="<?= get_stylesheet_directory_uri(); ?>/img/paypal.jpg"/>
                </a>
			</span>
