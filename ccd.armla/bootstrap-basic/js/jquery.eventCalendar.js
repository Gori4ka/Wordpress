...
;(function( $ ) {
	...
	function initEventCalendar(that, options) {
		...
		that.each(function(){
			...
			flags.wrap.on('click','.aaaaaaaaaa a',function(e){   //eventCalendar-day replace aaaaaaaaaa
			...
			if ( data.length ) {
				...
				$.each(data, function(key, event) {
					...
					if (eventYear == flags.wrap.attr('data-current-year') && eventMonth == flags.wrap.attr('data-current-month')) {
						...
						flags.wrap.find('.eventCalendar-currentMonth .eventCalendar-daysList #dayList_' + parseInt(eventDay)+' a').attr("href", event.url);
					}
